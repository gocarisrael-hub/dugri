...
const DEFAULT_FAQ = [
  {
    ...
    enabled: true,
    q: 'מה זה בעצם המשחק?',
    a: 'משחק ניחוש מילים שמבוסס כולו עליכם. שולפים קלף ומתארים את המילה בלי להגיד אותה, הקבוצה שלכם צריכה לנחש כמה שיותר מילים עד שהטיימר מצלצל. הקאץ׳ הוא שכל המילים עליכם! הכי מצחיק, אישי ומרגש!',
    link_text: '',
    link_url: '',
  },
  {
    ...
    a: 'מינימום 100, ועד 400. אנחנו שולחים דף עזר עם קטגוריות ודוגמאות שמקל מאוד להיזכר - אנשים, מקומות, בדיחות פנימיות, ביטויים ואקסים!',
    link_text: '',
    link_url: '',
  },
  {
    ...
    enabled: true,
    q: 'מתי בדיוק מקבלים?',
    a: 'הספירה מתחילה מרגע שאתם שולחים את רשימת המילים - לא מרגע התשלום. איסוף עצמי אפשרי תוך 3 ימי עסקים. יש לכם תאריך אירוע קרוב? דברו איתנו בוואטסאפ.',
    link_text: '',
    link_url: '',
  },
  {
    ...
    a: 'בוחרים חבילה ומשלמים באתר בתשלום מאובטח. מיד אחרי התשלום מקבלים הודעה במייל לאיסוף המילים, ומשם אנחנו מתחילים.',
    link_text: '',
    link_url: '',
  },
