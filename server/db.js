...
const db = {
  ...
  // Agent A: the discount coupons, in server/stores/commerce.js.
  ...commerceStore.couponsBlock({
    _db,
    saveDb,
    crypto,
    normCode,
  ...
  // Agent A: the physical stock, in server/stores/commerce.js.
  ...commerceStore.stockBlock({
    _db,
    saveDb,
    stockInt,
    sanitizeQuantity,
