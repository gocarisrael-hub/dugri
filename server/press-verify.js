...
// path can only ever hold a file that carries the four properties a shop needs.
...
//
// A byte scan is enough BECAUSE of what the press pass produces: Ghostscript
// runs at -dCompatibilityLevel=1.3, and PDF 1.3 predates object streams, so
// page dictionaries are written in the clear. (Under a newer compatibility
// level these could be compressed into an /ObjStm and invisible here — if that
// setting ever changes in generator/press.py, this scan has to change with it.)
