...
//
// The wizard blocks on GET /api/features at load and hides three gated features
// when their flag is off. On the e2e server every flag DEFAULTS OFF, so any spec
// that exercises colour picking, the word-font picker or the live name preview
// must stub the endpoint ON. We stub PER PAGE (page.route)
...
// All three flags on — the pre-flag behaviour (every feature visible). Import and
...
// All three flags off — the launch default (every gated feature hidden).
