# Template: birthday-girls-neon  (דוגרי יום הולדת בנות ניאון)
...
## fonts
- title_font: NeoNeon.otf
- word_font:  Cafe.ttf

## title
- title_text: "XOXO {NAME}'S BIRTHDAY"
- lines: 3  (XOXO / {NAME}'S / BIRTHDAY)
- language: english (CAPS, neon)
