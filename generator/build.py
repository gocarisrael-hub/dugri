...
def render_board(theme, board_clean, title_lines, out_png, chasers=False,
    ...
    frac = bd["frac"]
    title = rp.title_face(theme, title_lines, cfg)
    ...
    body = style + rp.title_block(box, title_lines, bd["fill"], bd["outline"],
                                  title.path, ts["outline_w"], ts["arch"], ts["shadow"],
...
def render_backs(theme, backs_clean, title_lines, out_png, word_font=None):
...
def build_pdf(theme, fronts, board, csvp, name, out_pdf, backs=None,
    ...
    _title = rp.title_face(theme, title_lines, cfg)
    rp.assert_title_drawable(_title.path, title_lines, theme=theme)
    ...
    back_png = None
    if backs:
        back_png = render_backs(theme, backs, title_lines,
